    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDPorudzbineAIP = table.Column<int>(type: "int", nullable: false),
                    IDArtiklaAIP = table.Column<int>(type: "int", nullable: false),
                    KolicinaArtikla = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtikliIPorudzbine", x => new { x.IDPorudzbineAIP, x.IDArtiklaAIP });
                    table.ForeignKey(
                        name: "FK_ArtikliIPorudzbine_Artikli_IDArtiklaAIP",
                        column: x => x.IDArtiklaAIP,
                        principalTable: "Artikli",
                        principalColumn: "ArtikalId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ArtikliIPorudzbine_Porudzbine_IDPorudzbineAIP",
                        column: x => x.IDPorudzbineAIP,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtikliIPorudzbine_IDArtiklaAIP",
